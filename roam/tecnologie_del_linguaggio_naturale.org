...
Per evitare /underflow/ nel moltiplicare tante probabilità molto piccole si utilizzano le probabilità logaritmiche agendo poi di somme.
*** Valutazione
- estrinsica
...
*** Triangolo Semiotico
- [[id:2a9268e6-9a2d-4db5-a886-f3b5a5d8752a][C.S Peirce]]
...
** Text Mining
- applicazioni di [[id:ec34a130-917a-4934-838e-5bf6c109584a][Data Mining]] al testo
...
- si utilizza la rappresentazione vettoriale di questi token[fn:: Rappresentazione inventata da Salton nel '74]
  ...
  + misura di similarità /cosine similarity/
    ...
    - coseno misura l'angolo tra due punti[fn:: Ogni documento è visto come un punto prendendo in considerazione il vettore corrispondente] dello spazio multi-dimensionale
*** Metodi Statistici
- frequenza
...
- Document Segmentation[fn:: Una sorta di topic modeling ma sequenziale e intradocumentale]
- Document Summarization[fn:: valutati utilizzando ROUGE (Recall-Oriented Understudy for Gisting Evaluation)]
  + estrattivi, estraggono le frasi più importanti[fn:: Uno degli algoritmi storici è TextRank]
...
- /Distributional Semantics/ in ambito di [[id:2f40aa67-3b3b-4cce-99bf-65b21ab34165][NLP]]
...
- altro problema è quello della *composizionalità*
  ...
  + possibile soluzione è quella di combinare vettori per una rappresentazione composta [fn:: il vettore di ~vino~ e quello di ~rosso~ li combino per creare un vettore di ~vino rosso~ ]
