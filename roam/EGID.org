...
** Dati Personali
*** Considerando
1. protezione delle presone fisiche con riguardo al trattamento dei dati di carattere personale é un diretto fondamentale
2. i principi e le norme a ... al trattamento dei dati personali dovrebbero rispettarne i diritti e le libertá fondamentali, in particolare il diritto alla protezione dei dati personali
4. il trattamento dei dati dewrebbe essere al servizio dell'uomo
6. rapiditá dell'evoluzione tecnologica e la globalizzazione comportano nuove sfide per la protezione dei dati personali
7. questa evoluzione richiede un quadro piú solido e coerente in materio di pretezione dei dati nell'Unione
8. gli Stati membri possono, nella minura necessaria per la coerenza e per rendere le disposizione nazionali comprensibile alle persone cui si applicano, integrare elementi del presente regolamento nel proprio diritto nazionale
*** Privacy
Concetto principalmente Americano, per la prima volta utilizzato da S. Warren e L. Brandeis in "The Right to Privacy"
*** Data Protection
...
**** Normative in vigore
- Regolamento Europeo 2016
  + tradizione della normativa ha sia contunuitá ma anche novitá
  + accountability
  + nomina del DPO/RPD
  ...
  + criteri proattivi di progettazione e tutela a norma
    - privacy dy design and by default
  + incremento diritti
    - revoca consenso
  + ambito di applicazione materiale
  + ambito di applicazione territoriale
    - trattamento effettuato nell'ambito di attivitá di soggetto stabilito UE
    - trattamento che si trovano in UE
    - trattamento effetuato da soggetto non stabilito in UE, ma soggetto al diritto di uno Stato membro per diritto
...
*Pseudonimo*
- il dato persanole spesso non é anonimizzato, ma reso meno facilmente intellegibile con le tecniche di pseudonimizzazione
  + trattamento dei tadi senza l'utilizzo di informaioni aggiuntive
    - a cond. che tali info siano conservate separatamente . soggette a misure tecniche e organizzative
  + contatore
...
**** Trattamento Dati* / data processing
...
- soggetti:
  ...
  + ruolo passivo - =diritti=
    - interessato
  + di controllo
    - ogni stato membro dispone di un'autorita per la protezione dei dati
...
- consenso
  + se richiesto deve essere libero, specifico, informato ed enequivocabile
...
- Valutazione della portata e gravitá
  ...
  + se rischio elevato, comunicaro agli interessati
...
- Interessato, deve essere tutelato
  ...
  + non essere sottoposto a decisione basata unicamente sul trattamento automatizzato, comprese la profilazione ceh produca effitti giuridice che lo riguardano o che indica in modo analogo significativamente sulla sua persona
**** Informative
- Caratteristiche
...
Invenzione, nuove e implicano un'attivitá inventiva e sono atte ad avere  una applicazione industriale
- novitá
- liceitá
- attivitá inventiva
...
*** Diritti Morali
Sono inalienabili, gli eredi possono far valere tali diritti senza limiti di tempo, non hanno scadenza
...
Sono alienabile (cedibili a terzi), durano tutta la vita dell'autore e fino a 70 anni dopa la sua morte, sono trasmissibili per ereditá
- pubblicare
...
Reputazione: considerazione in cui si é tenuti dagli altri
- Ingiuria
  + offesa all'onere o decoro di persona presente
  + aggravante se attribuzione di un fatto determinato
  + aggravante se in presenza di piú persone
- Diffamazione
  + comunicazione a piú persone (anche passaparola) che offende l'altrui reputazione
  + aggravante nell'attribuzione di un fatto determinato
  + aggravante usando qualsiasi messo di pubblicitá (es. Social)
  + reato a forma libera
  + reato di danno
- Libertá di pensiero
  + affinche una manifestazione del pensiero possa essere considerato rientrante nel diritto di critica e di cronaca:
    - veridicitá
    - continenza
    - interesse pubblico
- Facebook
