...
+ *Locus Commissi Delicti*
  - l'introduzione abusiva ... integrati nel luogo in cui l'operatore materialmente digita la passward di accesso o esegue la procedura di login, che determina il superamento delle misure di sicurezza
  - client / terminale
...
+ reato sussiste anche se i dati cancellati abusivamente possono essere recuperati
  ...
  - coerente anche con l'interpretazione tradizionale del reato di danneggiamento, deve la condatta criminosa apporti una modificazione - anche impedendone anche parzialmente l'uso - che richieda un intervento ripristinatorio dell'essenza e della funzionalitá della cosa stessa
