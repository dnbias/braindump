...
- il loro valore include sempre la concatenazione dei valori dello stesso attributo per tutte le variabili nel corpi di ogni produzione oltre che eventuali variabili ausiliarie
...
Se alla fine della stringa l'automa si trova in uno =stato finale= l'output sará "si", altrimenti "no"
