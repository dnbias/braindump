...
- il loro valore include sempre la concatenzazione dei valori dello stesso attributo per tutte le variabili nel corpi di ogni produzione oltre cheevetuali variabili ausiliarie
