...
A [[id:b7330c27-133a-4c8a-9e5b-17f8c1d71f0b][Python]] Data Science Platform.
To install in [[id:7951f0be-8c21-485b-a24b-e2bab3c9441a][NixOS]] see [[http://www.jaakkoluttinen.fi/blog/conda-on-nixos/][this]] great post, the author defined a nix expression:
#+begin_source nix
## ~/.conda-shell.nix
{ pkgs ? import <nixpkgs> {} }:
