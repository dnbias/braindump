...
On a forward pass through the tree you can remove the priviledges so that children do not start growing the tree while the system is collapsing it from the other children.
