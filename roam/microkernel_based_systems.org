...
Pipelining is not that easy because of dependencies between istructions
...
These =RAW= are so common that =ALU= has a bypass to itself to have the result back in the input in a single cycle
