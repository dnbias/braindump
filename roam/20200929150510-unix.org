...
+ shmget()
  - creazione
  - ottenere l'id di un segmento giá esistente
+ shmat()
  - attach
+ shmdt()
  - detach
...
+ shmctl()
  ...
  - un segmento sará effettivamente distrutto solo dope che tutti i processi correntemente attaccati lo avranno staccato
...
// RETURN VALUE: indirizzo base del segmento
