...
- $S$ is /indirectly consistent/ iff $Cl(S)$ is directly consistent, depends on the choice of strict rules (from logic)
*** Rationality Postulates
- *subargument closure*, to accept a proof you have to prove all their lemmas
- *direct consistency*
