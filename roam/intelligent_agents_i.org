...
Course taught by *Leon van der Torre* in University of Luxembourg.
...
- goal: check $A \in In(Lab)$ for grounded labelling $Lab$ of the =AF=[fn:: Argumentation Framework]
...
So the additions to [[id:92d4cd01-bf21-4c6c-8951-1f59512ea5a4][ASPIC+]] are *transposition* and *contraposition*.
