...
- based on socratic discussions
  + enquiry based on critical questions on entailed /consequences/, this is different from a classical discussion where the dialogue looks at the reasons that imply the main argument
