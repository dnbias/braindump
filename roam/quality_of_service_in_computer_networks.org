...
In general this assumption gives a good first approximation of the network, it is well known that the =OWTT= is overestimated using this indipendence assumption.
