...
#+begin_quote
Se esiste una soluzione, l'algoritmo di apprendimento termina, trovandola.
#+end_quote

La dimostrazione procede portando tutti i dati in un'unica classe $C$ che unisca $C_{1}$ e $C_{}_{}_{}_{}_{}_{2}$ e mostrando che esistono un lower bound $\alpha$ e un upper bound $\beta$ al numero di passi di iterazione $k$.
