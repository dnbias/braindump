...
Gli output $Z_{i}$ delle head vengono concatenate tra loro e moltipicate per i pesi imparati $W^{O}$. Si ottiene una matrice $Z$ finale della dimensione corretta, uguale alla dimensione dell'input $X$.
