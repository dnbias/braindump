...
##### Vincoli di chiave {#vincoli-di-chiave}
...
##### Vincoli di integritá referenziale {#vincoli-di-integritá-referenziale}
...
###### Azioni compensative {#azioni-compensative}
...
##### Strategie di progettazione {#strategie-di-progettazione}
...
##### Schema di Analisi {#schema-di-analisi}
...
##### Qualitá di uno schema ER {#qualitá-di-uno-schema-er}
...
###### Ristrutturazione dello schema concettuale (EER) {#ristrutturazione-dello-schema-concettuale--eer}
...
###### traduzione verso il modello logico e ottimizzazione {#traduzione-verso-il-modello-logico-e-ottimizzazione}
...
##### Problema dell'equivalenza {#problema-dell-equivalenza}
...
###### Teoria di Armstrong {#teoria-di-armstrong}
...
###### Chiusura di un insieme F {#chiusura-di-un-insieme-f}
...
##### Dipendenze Funzionali e Superchiavi {#dipendenze-funzionali-e-superchiavi}
...
##### Che conservano le dipendenze {#che-conservano-le-dipendenze}
...
##### Attributo estraneo {#attributo-estraneo}
...
##### Dipendenze ridondanti {#dipendenze-ridondanti}
