...
###### JAM - controlla la Highbit Network {#jam-controlla-la-highbit-network}
...
###### [Shifter]({{< relref "20200530050230-shifter.md" >}}) + [ALU]({{< relref "20200530050045-alu.md" >}}) {#shifter--20200530050230-shifter-dot-md--plus-alu--20200530050045-alu-dot-md}
...
###### Controllo del Bus C {#controllo-del-bus-c}
...
###### Controllo del Bus B {#controllo-del-bus-b}
...
###### goto(MBR OR Addr) {#goto--mbr-or-addr}
...
###### un incrementatore dedicato al PC {#un-incrementatore-dedicato-al-pc}


###### 16 bit per la porta della memoria di lettura di offset a 2 byte {#16-bit-per-la-porta-della-memoria-di-lettura-di-offset-a-2-byte}
...
###### il datapath mic-2 e' strettamente sequenziale {#il-datapath-mic-2-e-strettamente-sequenziale}

3 operazioni (sottocicli) che dipendono l'una dall'altra temporalmente


###### introduciamo 3 latch {#introduciamo-3-latch}
