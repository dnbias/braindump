...
##### In profonditá DFS {#in-profonditá-dfs}
...
##### In ampiezza BFS {#in-ampiezza-bfs}
...
-   nero: la radice e tutte le foglie (_nil_) sono nere
...
##### Versione piú concreta {#versione-piú-concreta}
...
##### Versione ulteriore BFS {#versione-ulteriore-bfs}
...
##### Versione ulteriore DFS {#versione-ulteriore-dfs}
...
#### Albero Minimo Ricoprente {#albero-minimo-ricoprente}
