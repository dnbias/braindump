...
##### Sistema | Kernel | Monitor | Supervisor {#sistema-kernel-monitor-supervisor}
...
##### `diagramma` di transizione degli stati di un processo {#diagramma-di-transizione-degli-stati-di-un-processo}
...
###### Scelte ingenieristiche {#scelte-ingenieristiche}
...
##### livello User {#livello-user}


##### livello Kernel {#livello-kernel}
...
##### CPU/CORE Multithreaded {#cpu-core-multithreaded}
...
##### Diagramma di accodamento {#diagramma-di-accodamento}
...
##### senza diritto di prelazione {#senza-diritto-di-prelazione}
...
##### con diritto di prelazione {#con-diritto-di-prelazione}
...
##### Nel Sistema Operativo {#nel-sistema-operativo}
...
###### Produttori e Consumatori {#produttori-e-consumatori}
...
###### Lettori e Scrittori {#lettori-e-scrittori}
...
###### Cinque Filosofi {#cinque-filosofi}
...
##### Allocazione contigua a partizioni multiple fisse {#allocazione-contigua-a-partizioni-multiple-fisse}
...
##### Allocazione contigua a partizioni multiple variabile {#allocazione-contigua-a-partizioni-multiple-variabile}
...
##### Paginazione a piu' livelli {#paginazione-a-piu-livelli}
...
###### Tabella delle Pagine Invertita `IPT` {#tabella-delle-pagine-invertita-ipt}
...
###### Supporto Hardware {#supporto-hardware}
...
###### Considerazioni sulle pagine {#considerazioni-sulle-pagine}
...
##### Area di Swap {#area-di-swap}


###### Memorizzazione Pagine {#memorizzazione-pagine}
...
###### Liberare Spazio {#liberare-spazio}
...
###### Accesso rapido ai file {#accesso-rapido-ai-file}
...
###### Protezione dei file {#protezione-dei-file}
...
###### allocazione contigua - buono per l'area di swap {#allocazione-contigua-buono-per-l-area-di-swap}
...
###### allocazione concatenata {#allocazione-concatenata}
...
###### Elenco dei Blocchi Liberi {#elenco-dei-blocchi-liberi}
...
##### Efficienza | Prestazioni {#efficienza-prestazioni}
