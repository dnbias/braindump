...
##### Punto di vista estensionale {#punto-di-vista-estensionale}

\\(f = \\{(0,1),(1,2),(2,5),\cdots\\}\\)


##### Punto di vista intensionale {#punto-di-vista-intensionale}
...
##### Convenzioni Sintattiche {#convenzioni-sintattiche}
...
##### &alpha;-conversione {#and-alpha-conversione}
...
##### &beta;-riduzione {#and-beta-riduzione}
...
##### &eta;-riduzione {#and-eta-riduzione}
...
##### Strategie di Riduzione {#strategie-di-riduzione}

In alcuni casi é piú efficiente l'uno, in altri l'altro


###### Ordine Applicativo {#ordine-applicativo}
...
###### Teorema Normalizzazione {#teorema-normalizzazione}
...
##### Estendere il calcolo {#estendere-il-calcolo}
...
###### Sistema di tipi {#sistema-di-tipi}
...
##### Fase di Costruzione dell'albero sintattico {#fase-di-costruzione-dell-albero-sintattico}
...
##### Fase dell'Annotazione dell'albero sintattico {#fase-dell-annotazione-dell-albero-sintattico}
...
##### Fase di Risoluzione dei vincoli {#fase-di-risoluzione-dei-vincoli}
...
##### Principio di Induzione Forte {#principio-di-induzione-forte}

\\((\forall m < n : P (m)) \implies P(n)\\: \forall n \in \mathbb{N}\\)


##### Principio di Induzione sulle liste finite {#principio-di-induzione-sulle-liste-finite}
...
##### Contatore accessi Web {#contatore-accessi-web}
...
##### Fibonacci Logaritmico {#fibonacci-logaritmico}
...
##### Java Virtual Mini-Machine {#java-virtual-mini-machine}
...
###### Dall'iterazione alla ricorsione {#dall-iterazione-alla-ricorsione}
