...
##### Linux e' il kernel {#linux-e-il-kernel}
...
###### Permette l'accesso all'hardware {#permette-l-accesso-all-hardware}
...
###### Operazioni sul Filesystem {#operazioni-sul-filesystem}


###### Un kernel e' construito per un hardware specifico {#un-kernel-e-construito-per-un-hardware-specifico}


##### Shell {#shell}


###### interprete di comandi {#interprete-di-comandi}


###### permette l'interazione utente - sistema {#permette-l-interazione-utente-sistema}


###### oggetto utilizzato per l'amministrazione della macchina {#oggetto-utilizzato-per-l-amministrazione-della-macchina}
...
###### permette all'utente di {#permette-all-utente-di}
...
###### Componenti Riutilizzabili {#componenti-riutilizzabili}
...
###### File in formati aperti {#file-in-formati-aperti}
